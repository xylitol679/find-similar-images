...
import com.ocbg.xyz.apps.ui.base.BaseUiActivity
 ...
 */
abstract class HelperActivity<T : ViewBinding> : BaseUiActivity<T>() {
    ...
    private val launcherAllFile =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { _ ->
            if (Environment.isExternalStorageManager()) {
                ...
                MToast.show(this, getString(R.string.helper_permission_grant_fail))
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onCreate ${getName()}")
    }

    override fun onStart() {
        super.onStart()
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onStart ${getName()}")
    }

    override fun onRestart() {
        super.onRestart()
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onRestart ${getName()}")
    }

    override fun onResume() {
        super.onResume()
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onResume ${getName()}")
    }

    override fun onPause() {
        super.onPause()
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onPause ${getName()}")
    }

    override fun onStop() {
        super.onStop()
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onStop ${getName()}")
    }

    override fun onDestroy() {
        super.onDestroy()
        MLog.d(LogTag.LIFECYCLE_ACTIVITY, "onDestroy ${getName()}")
    }
    ...
    private fun showManageAllFilePermissionDialog() {
                ...
                override fun onConfirmClick() {
                    try {
                        ...
                        val intent = Intent(Settings.ACTION_MANAGE_APP_ALL_FILES_ACCESS_PERMISSION).apply {
                            data = Uri.parse("package:${this@HelperActivity.packageName}")
                        }
        ...
        }.show(supportFragmentManager, "ManageAllFilePermissionDialog")
    }
    ...
    private fun showStoragePermissionDialog() {
        ...
        }.show(supportFragmentManager, "StoragePermissionDialog")
    }
